...
me.family = ['Rachel','Mike','Lynn']

document.getElementById('q2').innerHTML = me.name + ", " + me.city + ", " + me.jobTitle + ", " + me.family
...
document.getElementById('q3a').innerHTML = "Dot notation = " + me.city //dot notation

document.getElementById('q3b').innerHTML = "Bracket notation = " + me["city"]   //bracket notation
...
document.getElementById('q6').innerHTML = invitees.adults[2].specialConsiderations.seating + " and " +  invitees.adults[2].specialConsiderations.allergies
...
document.getElementById('q8').innerHTML = "Lauren's appetizer is " + invitees.adults[2].dinnerChoice[0] +
". She will be eating " + invitees.adults[2].dinnerChoice[1] + " for dinner and has selected " + invitees.adults[2].dinnerChoice[2] + " as her dessert."
...
jsWorkshop.classmates = ["Tom","Nick","Trevor","Tim","John"]
...
document.getElementById('q13').innerHTML = jsWorkshop
...
document.getElementById('qc').innerHTML = books.ISBN13579.author

// D. Get the length of the author the the third book.

document.getElementById('qd').innerHTML = books.ISBN13579.author.length

// E. To each book object variable, add a key of "dateRead" with a value of the year you read the book.
//     (Go ahead and make this up, too. Get wild.)

books.ISBN12345.dateRead = "May 1, 1990";
books.ISBN67890.dateRead = "March 5, 1988";
books.ISBN13579.dateRead = "July 23, 2006";

document.getElementById('qe').innerHTML = books

// F. Remove the second book from the books object.

delete books.ISBN67890
